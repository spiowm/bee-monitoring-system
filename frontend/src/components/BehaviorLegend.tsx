...
const BEHAVIORS: BehaviorInfo[] = [
  ...
  },
  {
    ...
    thresholds: '≥3 захисниці в радіусі 2 довжин бджоли, кут на ціль ±30°, тривалість >2 с',
  ...
  },
  {
    ...
    label: 'Невизначено',
    short: '?',
    description: 'Бджола відстежена достатньо довго (≥15 кадрів), але жоден поведінковий патерн не підходить. Можливо, бджола просто сидить або повільно переміщується.',
    thresholds: 'Не відповідає критеріям жодної з чотирьох поведінок',
    cssVar: '--behavior-unknown',
  },
];
